...
menu:
  leftnav:
    identifier: aca71e367f135bae8306f900a9bd77ab
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: aca71e367f135bae8306f900a9bd77ab
...
Additional readings are also required and cited on the [Readings]({{< baseurl >}}/sections/readings) page. These required readings include excerpts from the following books, although reading these books in their entirety is also highly recommended:
...
Information on the team project can be found in the [Projects]({{< baseurl >}}/sections/projects) section.
